  ...
  return (
    <div className="grid md:grid-cols-2 gap-x-20 gap-y-16 items-start">
      ...
      <div className="relative h-[900px] flex items-center justify-end -mb-32">
        ...
        <Image id="phone-two" src="https://azure-wrong-tortoise-997.mypinata.cloud/ipfs/bafkreihwenfmhguuodhr66qojytmdmd4bc3jw7gcf2xynneitvygkpyah4" alt="Phone 2" width={1200} height={3200} className="absolute top-0 right-12" />
      </div>
    </div>
  );
};
