  ...
  return (
    <div className="grid md:grid-cols-2 gap-x-20 gap-y-16 items-start">
      ...
      <div className="relative h-[600px] md:h-auto -mb-32 flex justify-center md:justify-end">
        <div className="relative w-full h-[600px] md:w-[48rem] md:h-[900px] flex justify-center ml-[80px] md:ml-0">
            <Image id="phone-one" src="https://azure-wrong-tortoise-997.mypinata.cloud/ipfs/bafybeigxtetzktxivcogpz3ixdrrglolgzqkrhwexre7piytayg45n7cti" alt="Phone 1" width={1200} height={3200} className="absolute top-10 z-10 w-80 md:w-[48rem] h-auto left-1/2 -translate-x-1/2 md:left-auto md:right-0 md:translate-x-0" />
